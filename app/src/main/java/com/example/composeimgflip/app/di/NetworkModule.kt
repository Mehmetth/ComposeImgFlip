...
import com.example.composeimgflip.BuildConfig
...
object NetworkModule {
    ...
    @Provides
    @Singleton
    fun provideRetrofitService(retrofit: Retrofit): ImgFlipService {
        return retrofit.create(ImgFlipService::class.java)
    }
}